---
title: "Winning CPTC"
description: "A chronological retelling of how we went from a brand new team to winning the Global Finals of the Collegiate Penetration Testing Competition."
date: 2026-02-02
...
It is important to note that while it was our first appearance in CPTC, we had quite a few advantages going in. First, our club is in possession of some very powerful servers that allowed us to build practice cyber ranges and set up previous competition infrastructure to get some solid practice on CPTC networks without even competing. Second, our school had fielded a CPTC team in the past(the year before I joined UCI), and I was in contact with the previous [team captain](https://www.linkedin.com/in/xlin1/) who had already graduated. He provided us with a lot of advice on how to train the team, and some first-hand knowledge of what we could expect in the competition. Most importantly, I want to thank our mentor [Ryan Krause](https://www.linkedin.com/in/rtkrause/), a Principal Security Consultant at NetSPI, another UCI alum who gave a guest lecture for our club on Penetration Testing. When we told him about CPTC, he was very excited to help our team out and provided us with a wealth of advice on training resources and how to improve in Penetration Testing.
...
The [Collegiate Penetration Testing Competition](https://cp.tc/) is an offensive security competition where students have to hack into a simulated business environment. The student teams will then document all of their findings and prepare a penetration testing report to deliver to the simulated business.
...
![Bathroom Selfie = 300x200](/images/winning-cptc/bathroom-selfie-regionals.jpg)
...
We learnt AWS through a few mini CTF platforms, including Wiz’s [IAM Challenge](https://www.wiz.io/blog/the-big-iam-challenge), <http://flaws.cloud/>, and <http://flaws2.cloud/>. We also researched and practiced using multiple tools that could help with hacking AWS, including [pacu](https://github.com/RhinoSecurityLabs/pacu) and [awspx](https://github.com/ReversecLabs/awspx). While we did learn a lot, it was ultimately not relevant to CPTC because there was no AWS environment in the finals.
...
To strengthen our Windows expertise, I had the Windows team work through more advanced Hack The Box machines and complete a full clear of GOAD, following the entire [walkthrough](https://mayfly277.github.io/categories/goad/) from start to finish. In addition, they developed custom Python tooling to streamline Windows penetration testing. This included building a wrapper around NetExec to automate vulnerability scanning, ADCS exploitation, Password spraying, and common Active Directory attack techniques such as ASREPRoasting and Kerberoasting.
...
![im-in.png](/images/winning-cptc/im-in.png)
...
![finished-report.jpg](/images/winning-cptc/finished-report.jpg)
